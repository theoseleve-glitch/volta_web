# Volta Drinks — Complete Build Package

**For:** Théo → Client (Volta Drinks founder)
**Prepared:** April 2026
**Scope:** B2C Shopify storefront, FR/EN, subscription-enabled, Awwwards-level motion, playful mascot brand
...
1. **Part A — Strategic Context** (read first, orients everything)
2. **Part B — Prompts for Claude Code** (sequenced, paste each into your terminal)
3. **Part C — Questions for the Client** (send him this list; answers unlock final content)
4. **Part D — The Competitive/Risk Report** (separate PDF-style document for him)

The prompts in Part B are ordered. Don't skip steps. Each one assumes the previous one finished. If something breaks, fix it before moving on — debt compounds faster than you think in a themed build.
...
# PART C — QUESTIONS FOR THE CLIENT

Send him this list. Answers unlock final content, final branding, and remove the placeholders in the code.

## Brand & identity

1. **Exact brand green hex code?** The logo appears to be roughly `#4ADE80` but I'm eyeballing. If you have a brand guidelines doc or the original illustrator file, I need the precise hex (or Pantone, or CMYK).

2. **Is the mascot final?** The playful lightning-bolt character is charming but it currently has a hand-drawn / stock-illustration feel. For an Awwwards-level site we'd ideally refine it: cleaner vector lines, more expressive face, multiple poses (idle, charging, celebrating, sad/empty). Do you want to:
   - (a) Keep the current mascot as-is
   - (b) Have it refined by an illustrator (budget ~€500-2000 for a proper mascot sheet)
   - (c) Generate variants with AI (faster, cheaper, less control)

3. **Do you have any other visual assets?** Photography, videos, illustrations, patterns, icons? Send everything you have.

4. **Brand voice — tu or vous?** I'm assuming "tu" (closer, playful, matches the mascot). Confirm or correct.

5. **Tagline?** The placeholder is "CHARGE TON JUS" — do you have something official, or should I propose 3-5 alternatives?

## Product line

6. **Confirm the final flavor lineup.** My placeholders are:
   - Ginger Classic (ginger/pineapple/lemon — the flagship from Claude's memory)
   - Citrus Storm (???)
   - Tropical Jolt (???)
   - Deep Root (???)
   
   What are the real flavor names and ingredient compositions?

7. **Final prices?**
   - Single shot: €3 ✅
   - 6-pack: €15 ✅ (€2.50/unit — 17% discount)
   - 12-pack: €__ (suggest €27-28 — ~10% further discount)
   - Mixed subscription pack: €__ (suggest €30/month for 12 shots with -30% subscription = effectively €21/month net)
   
   Are these prices locked, or do you want me to run a quick pricing analysis against competitors (ginger shots typically €3.50-5 per unit in France)?

8. **What's in the Mixed Pack exactly?** 12 shots of mixed flavors — is that 3 of each (if 4 flavors)? Does the customer choose the mix, or is it curated?

9. **Shipping threshold for free shipping?** Placeholder is €25. Your margins need to support this.

## Subscription mechanics

10. **Cadence.** You said monthly. Do you want to also offer bi-weekly (every 2 weeks) as an option? Some customers drink shots daily and would run out in a month.

11. **Subscription discount.** -30% confirmed. Does this apply to:
    - (a) Single shot subscription only
    - (b) All pack sizes on subscription
    - (c) Only the Mixed Pack
    
    I'm assuming (b). Confirm.

12. **Pause/skip/cancel rules?** Most successful subscription brands allow:
    - Pause anytime (up to 3 months)
    - Skip next delivery anytime
    - Swap flavors before the next charge date
    - Cancel anytime, no fees
    
    This is what Seal supports out of the box. Confirm this is your policy. If you want friction (e.g., "cancel only after 3 months") I'd push back — it hurts conversion more than it helps retention.

## Operations

13. **Where are you shipping from?** The fulfillment address determines shipping zones, rates, and estimated delivery times displayed on site.

14. **Fulfillment — in-house or 3PL?** Affects order processing SLAs and the "Livraison 48h" claim on the product page. Do not make that claim if you can't hit it.

15. **Shelf life of the shots?** Relevant for the subscription model — can a 12-pack last 30 days at room temp, or does it need refrigeration? This changes the entire subscription pitch.

16. **Carrier?** Colissimo, Chronopost, DHL? Determines rates and tracking integration.

## Legal & compliance (CRITICAL)

17. **Have you secured "Volta Drinks" as a trademark in France or EU?** If not, do it now. See the risk report (Part D) — this is the single biggest issue in the project.

18. **Have you engaged a food safety consultant for HACCP?** Required for beverage production in France.

19. **Who wrote your CGV, Mentions légales, Politique de confidentialité?** These need to be legally compliant in France (specifically Code de la consommation + RGPD). Don't use ChatGPT outputs for these. Use a service like Legalstart, or hire a lawyer (€500-1500 one-time).

20. **Nutritional claims.** "Functional" is marketing; "boosts energy" is a regulated health claim in EU. What claims do you want on packaging and site? I'll flag any that are non-compliant.

21. **Allergen declarations?** Ingredients list + allergen information must be present on every product page (EU regulation 1169/2011).

## Marketing & data

22. **Existing social presence?** Instagram handle, TikTok? Link in footer.

23. **Do you have Klaviyo or another email tool?** If not, I recommend Klaviyo for Shopify — native integration, free up to 250 contacts.

24. **Running paid ads at launch?** Meta Ads, Google Ads, TikTok Ads? Changes the pixel setup and landing page priorities.

25. **Any existing customers from pre-launch or a waitlist?** If yes, we set up a "founding customers" launch offer.

26. **Review strategy — which app?** Judge.me (free tier), Loox (photo reviews, paid), or Yotpo (enterprise)? I recommend Judge.me for launch.

## Design references

27. **Which existing websites do you like?** Send 3-5 examples — ideally not direct competitors, but sites whose vibe/motion/tone you want to approach. Awwwards SOTY archive is fair game.

28. **Which do you hate?** Knowing what to avoid is as useful as knowing what to aim for.

## Logistics of the build

29. **When do you want to launch?** Sets the pace of the build and determines what's cut from v1.

30. **Budget for premium assets?** Lottie mascot animation (~€300-800 from a freelance animator), product photography (~€500-1500 for a proper shoot), stock audio if we do sound (~€50-100). Can sidestep all of it with placeholders, but quality suffers.

---

# PART D — RISK & COMPETITIVE REPORT (for client)

*This is the JP Morgan-style analysis you asked for. It will be generated as a separate PDF document. See the next section of this package for that deliverable.*

---

## FINAL NOTES TO YOU (Théo)

Three things to flag:

**1. Trademark risk is real and urgent.** A US company called Volta operates at drinkvolta.com selling "Energy Vita-Serum" liposomal supplements out of Nashville. Their positioning is tapping into the "trillion-dollar wellness economy" with liposomal delivery technology. They aren't a beverage brand in the same category as your client — they're a supplement — but the name is identical and the category (wellness/energy) is close. If they have EU trademark rights, your client is at risk. If they don't, your client should race to register EU/FR first. **This decision needs to happen before the site launches, not after.** The full analysis is in the separate PDF.

**2. The "playful mascot + Awwwards-level + conversion-optimized" triangle.** I've designed around it: the mascot IS the signature moment, the motion serves selling rather than art, and the Lenis/GSAP layer provides the polish without sacrificing performance. But the mascot HAS to move for this to work. If the client won't invest in a proper animated mascot (Lottie file from a freelance animator, ~€300-800 one-time), the site becomes either generic playful or generic Awwwards. Push him on this budget item.

**3. The subscription model is where the business actually is.** Every piece of the build assumes subscribers are worth significantly more than one-time buyers. The -30% discount is aggressive but correct; the math only works if subscribers stay ≥4 months. Make sure the client has flows for subscriber onboarding (Klaviyo "welcome subscriber" flow), churn prevention (60-days-in re-engagement), and LTV tracking. I've set up the events in Prompt 13; he needs to configure the flows.

Good luck with the build. Ship fast, iterate faster.
